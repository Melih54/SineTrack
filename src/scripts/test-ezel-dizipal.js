...
const html = execSync('curl.exe -s -L -A "Mozilla/5.0" "https://dizipal1581.com/bolum/ezel-1x1"', { maxBuffer: 10 * 1024 * 1024 }).toString('utf8');
const iframeUrl = decryptDizipal(html);
console.log("Ezel 1x1 Iframe URL:", iframeUrl);

const htmlGibi = execSync('curl.exe -s -L -A "Mozilla/5.0" "https://dizipal1581.com/bolum/gibi-1x1"', { maxBuffer: 10 * 1024 * 1024 }).toString('utf8');
const iframeGibi = decryptDizipal(htmlGibi);
console.log("Gibi 1x1 Iframe URL:", iframeGibi);
