...
console.log("contentItem keys:", Object.keys(result.contentItem || {}));
console.log("content keys:", Object.keys(result.content || {}));
if (typeof result.content === "string") {
  console.log("content is string:", result.content.slice(0, 500));
} else {
  console.log("content preview:", JSON.stringify(result.content, null, 2).slice(0, 500));
}
